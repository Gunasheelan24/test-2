...
function createButton() {
    ...
    btn.type = 'button'
    btn.setAttribute('class', 'btn btn-danger text-center mt-5')
    btn.onclick = action;
...
function createMultiSelect() {
    ...
    var opt2 = new Option('Dosa', 'Dosa');
    var opt3 = new Option('Idly', 'Idly');
    var opt4 = new Option('Fried Rice', 'Fried Rice');
    var opt5 = new Option('Chicken Biryani', 'Chicken Biryani');
    opt2.selected = true;
